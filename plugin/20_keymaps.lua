...
nmap_leader('ee', '<Cmd>Oil<CR>',                           'Explorer')
...
-- - `<Leader>gs` - show blame for current line
-- - `<Leader>go` - toggle inline current-line blame
...
nmap_leader('go', '<Cmd>Gitsigns toggle_current_line_blame<CR>', 'Toggle blame')
nmap_leader('gs', '<Cmd>Gitsigns blame_line<CR>',                'Show line blame')

xmap_leader('gs', '<Cmd>Gitsigns stage_hunk<CR>', 'Stage hunk')
...
--
-- NOTE: these provide a consistent, mnemonic layer for common LSP actions.
