...
--
-- See also:
-- - `:h tokyonight.nvim` - available options and styles
-- - `:h :colorscheme` - built-in colorscheme command
now(function()
  vim.cmd('colorscheme tokyonight')
end)

-- You can try these other 'tokyonight' styles:
-- now(function() vim.cmd('colorscheme tokyonight-storm') end)
-- now(function() vim.cmd('colorscheme tokyonight-moon') end)
-- now(function() vim.cmd('colorscheme tokyonight-night') end)
-- now(function() vim.cmd('colorscheme tokyonight-day') end)
...
later(function()
  ...
  map.setup({
    ...
    -- Show built-in search matches, gitsigns hunks, and diagnostic entries
    integrations = {
...
later(function()
  ...
  local lang_patterns = {
    ...
    -- Recognize snippets for inline markdown contexts
...
-- strings but can be less accurate than parser-aware approaches.
